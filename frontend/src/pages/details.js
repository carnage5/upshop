...
function Details() {
  ...
  <div className="container px-5 py-24 mx-auto ">
    <div className="lg:w-4/5 mx-auto flex flex-wrap bg-gray-100 rounded-lg p-10 ">
      <img  className="lg:w-1/2 w-full object-contain aspect-[3/2] object-center rounded" src={loc.state.details.imgsrc}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          ...
          <span className="mr-3">Quantity</span>
            ...
            <input type="number" onChange={changeval} value={quan} className="rounded w-20 border appearance-none border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-500 text-base p-2"/>
